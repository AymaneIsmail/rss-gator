...
func main() {
	...
	commands.register("agg", feedHandler)
	...
	commands.register("following", middlewareLoggedIn(listFollowFeeds))
	commands.register("unfollow", middlewareLoggedIn(unfollowFeedHandler))
